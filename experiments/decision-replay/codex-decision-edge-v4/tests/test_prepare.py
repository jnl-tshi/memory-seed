...
EXPECTED_TASK_SHA256 = "f41b05b8c0ab570e2c9b1ef1ce03c0d4b40d3471720ec72ae0954ceabdd8a7a7"
...
class PrepareStudyTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        cls.temporary = tempfile.TemporaryDirectory(prefix="codex-decision-edge-v4-test-")
