...
class GraderContractTests(unittest.TestCase):
    def test_frozen_gate_and_report_schema(self) -> None:
        self.assertEqual(6, grade.SCHEMA_VERSION)
        self.assertEqual("codex-decision-edge-v4-semantic-v1", grade.ORACLE_VERSION)
        ...
        self.assertEqual(6, round_trip["schema_version"])
