"""Qualify the Codex v4 preparer, grader, reference, and live mutants."""
...
def _task1_controls(prepared_root: Path) -> dict[str, object]:
    ...
    if relationship["withheld_parent"] != SOURCE_REVISION or len(fixtures) != 3:
    ...
    neutral = fixtures[-1] / ".memory-seed" / "sessions" / ".gitkeep"
