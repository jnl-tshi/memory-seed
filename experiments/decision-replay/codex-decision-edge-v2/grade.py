...
PUBLIC_COMMAND = (sys.executable, "-m", "unittest", PUBLIC_TEST_PATH.as_posix())
SCHEMA_VERSION = 4
GRADER_VERSION = "codex-decision-edge-grader-v4"
...
def _public_gate(candidate_copy: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "command": "python -m unittest memory-trace/tests/test_trail_decision_edges.py",
...
def _error_report(
    ...
    report = {
        ...
        "oracle": {
            ...
            "version": "codex-decision-edge-semantic-v1",
