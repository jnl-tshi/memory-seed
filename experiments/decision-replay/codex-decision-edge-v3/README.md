...
```powershell
python experiments/decision-replay/codex-decision-edge-v3/prepare.py `
  --seed 20260816 `
...
python -m unittest discover `
  -s experiments/decision-replay/codex-decision-edge-v3/tests `
  -p "test_*.py"

python experiments/decision-replay/codex-decision-edge-v3/verify_harness.py
```
...
```powershell
python experiments/decision-replay/codex-decision-edge-v3/grade.py `
...
The schema-v5 JSON reports separate decision-row, two-way focus, non-projection equality, entry-ref,
