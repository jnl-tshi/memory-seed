...
EXPECTED_TASK_SHA256 = "002895f0bb02eb82b62bd6f17e8607183abcce99221b70515da9749aa311ce71"
...
class PrepareStudyTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        cls.temporary = tempfile.TemporaryDirectory(prefix="codex-decision-edge-v3-test-")
    ...
    def test_default_fixture_root_prepares_a_patch_writable_primary_checkout_fixture(self) -> None:
        ...
        try:
            ...
            self.assertEqual(3, result["fixture_count"])
