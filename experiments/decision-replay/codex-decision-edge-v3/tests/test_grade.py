...
class GraderContractTests(unittest.TestCase):
    def test_frozen_gate_and_report_schema(self) -> None:
        self.assertEqual(5, grade.SCHEMA_VERSION)
        self.assertEqual("codex-decision-edge-v3-semantic-v1", grade.ORACLE_VERSION)
        ...
        self.assertEqual(5, round_trip["schema_version"])
