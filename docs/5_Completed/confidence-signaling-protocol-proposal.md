...
date: "2026-07-05"
project: "memory-seed"
related_to: "business/market/memory-trail-competitor-analysis.md; docs/5_Completed/risk-signaling-and-stop-triggers-plan.md"
...
> [`memory-trail-competitor-analysis.md`](../../business/market/memory-trail-competitor-analysis.md) - the `frmoretto/memory-trail`
...
> to Memory Seed's own conventions, and proposes where it would live if promoted to `docs/2_Todo/`.
...
- **Combine or split from the STOP-trigger taxonomy?** They are two faces of one coherent system
  ...
  from a security-review context). Recommend deciding this when scoping the `docs/2_Todo/` plan.
...
- [`memory-trail-competitor-analysis.md`](../../business/market/memory-trail-competitor-analysis.md) (this repo, 2026-07-05)
