...
completion_note: "Four recorded runs completed the engineering experiment; any external benchmark submission remains an explicit non-technical user choice."
