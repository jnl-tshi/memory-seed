...
**As of:** 2026-07-04 · control-plane `2.14` · package `2.14.0`
...
graph LR
  ...
  VNext["Unreleased — supersedes · commits · importance_score"]
  V30["Next — exclude-superseded filter · related P2 · Lense/package decisions"]
...
- `tests/test_memory_seed.py`, `tests/test_session_schema.py`, `tests/test_semantic_cache.py`,
  ...
  field naming, and seed/live parity. Current suite: **237 tests** (verified 2026-07-04).
