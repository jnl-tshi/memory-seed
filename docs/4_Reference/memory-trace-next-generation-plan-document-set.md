# Memory Trace Next-Generation Plan Document Set
...
- `docs/2_Todo/memory-trace-plan-integration-and-retirement-guide.md`

The existing `memory-trace-ai-timeline-summarisation-plan.md` remains active and is cross-linked to
the derived-artifact provenance contract.
