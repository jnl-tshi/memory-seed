...
<!-- docs-index:begin -->
Counts (Markdown files directly in each lane, lane `README.md` excluded): 1_Inbox 16 · 2_Todo 8 · 3_Spec 10 · 4_Reference 28 · 5_Completed 87 · 6_Rejected 3 · 7_Replaced 54 · 8_Deferred 14

Top open items (P0/P1 in `2_Todo/`):
- **P0** [hosted-memory-mvp-programme.md](2_Todo/hosted-memory-mvp-programme.md) — Complete P0.1 authority closeout, then run the Codex capture and approval feasibility spike without uploading private data.
