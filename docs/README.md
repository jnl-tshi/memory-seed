...
Inbox 5 · Todo 16 (incl. `0_NEXT_STEPS.md`, now paused) · Completed 5 (+43 still in `2_Todo/completed/`,
pending the P2 bulk migration) · Superseded 2 · Deferred 2 · Spec 5 live + candidates · Reference 13 ·
plus top-level `CONSTITUTION.md`.
