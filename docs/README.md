...
- **P1** [memory-index-dry-run-plan.md](2_Todo/memory-index-dry-run-plan.md) — JNL decides whether to submit to Verging Labs v0.2 (early September), reading the capture-loss finding below first - it is a real, reproduc…
