...
Updated 2026-07-14 after an inbox+todo evaluation, a strategy-doc triage, and the Constitution-first pause.
Inbox 5 · Todo 18 (incl. `0_NEXT_STEPS.md`; development resumed Constitution-aligned; +2 promoted persona
context-efficiency proposals) · Completed 6 (+43
