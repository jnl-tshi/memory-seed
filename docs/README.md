...
- **P1** [reflection-ledger-workstream-evolution-plan.md](2_Todo/reflection-ledger-workstream-evolution-plan.md) — Finish reviewed v2 core hardening; independently review the v1 authoring-retirement amendment before removing legacy writers and launching …
- **P1** [reflection-v1-authoring-retirement-plan.md](2_Todo/reflection-v1-authoring-retirement-plan.md) — Independent plan review, then retire v1 authoring after the reviewed v2 core lands and before reflection surfaces launch.
