...
- **P1** [plan-reflection-ledger.md](2_Todo/plan-reflection-ledger.md) — Review the temporary-ledger contract and the three dispatch drafts; then land the serial foundation before any worker creates a reflection …
