...
Design + rationale: [`1_Inbox/document-lifecycle-system-plan.md`](1_Inbox/document-lifecycle-system-plan.md).
...
| `2_Todo/Claude/`, `2_Todo/codex/` | per-agent proposal-synergy reviews (`status: draft`) | **reconcile in P2** (fold into a lane) |
...
## Current state (P1 snapshot — will be regenerated by `docs index`)

Inbox 6 · Todo 21 · Completed 43 (in `2_Todo/completed/`, pending P2 move) · Spec 5 live + 2 candidate ·
Reference 10.
