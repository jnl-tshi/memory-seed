...
Inbox 5 · Todo 17 (incl. `0_NEXT_STEPS.md`, now paused) · Completed 5 (+43 still in `2_Todo/completed/`,
pending the P2 bulk migration) · Superseded 2 · Deferred 2 · Spec 5 live + 3 candidate (incl. the
derived-projection contract) · Reference 13 · plus top-level `CONSTITUTION.md`.
