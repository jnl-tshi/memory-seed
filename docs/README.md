...
- **P1** [memory-provenance-and-authority-taxonomy-proposal.md](2_Todo/memory-provenance-and-authority-taxonomy-proposal.md) — Steps 4–6: display provenance and authority distinctly in Trace/evidence views; implement actionability as a policy result with reason code…
