...
Updated 2026-07-14 after an inbox+todo evaluation, a strategy-doc triage, the Constitution-first pause, and
promoting the ranking/graph-quality trio (inbox → todo).
