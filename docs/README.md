...
- **P1** [reflection-ledger-workstream-evolution-plan.md](2_Todo/reflection-ledger-workstream-evolution-plan.md) — Independently review the admitted-compaction amendment before any further v2 implementation; do not reopen or implement it without that rev…
