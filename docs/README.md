...
promoting the ranking/graph-quality trio (inbox → todo), and capturing the grounding-provenance write-time
links proposal.
Inbox 3 · Todo 21 (incl. `0_NEXT_STEPS.md`; development resumed Constitution-aligned; +2 persona
context-efficiency proposals; +3 promoted ranking/graph-quality proposals) · Completed 6 (+43
