...
spec_binding: rejected
rejected_on: "2026-09-19"
rejected_reason: "The ratified edition split makes hosted SQL authoritative; repository Markdown settlement would recreate dual-authority synchronization."
replaced_by: "docs/3_Spec/edition-authority-contract.md"
tags:
  - memory-seed
  - spec
  - architecture
...
**Status:** **REJECTED 2026-09-19.** Retained for its idempotency, conflict, export and security reasoning,
but its Markdown-settlement authority model is replaced by
[`edition-authority-contract.md`](../3_Spec/edition-authority-contract.md).
It refines the deferred
[`memory-trace-hosted-product-and-security-architecture.md`](../7_Replaced/memory-trace-hosted-product-and-security-architecture.md)
