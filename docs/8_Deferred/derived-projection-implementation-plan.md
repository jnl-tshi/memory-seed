...
deferred_reason: "Derived projection implementation is outside the hosted capture-first MVP."
revisit_when: "Hosted capture, retrieval, and curator evidence justify a projection build."
...
([`0_NEXT_STEPS.md`](../2_Todo/0_NEXT_STEPS.md)). Next increment: Phase 2 (git-rooted integrity).
