...
deferred_reason: "Optional collaboration-framework integration is not part of the hosted MVP."
revisit_when: "A current workflow gap remains after the hosted MVP foundations land."
