...
deferred_reason: "Structural graph enrichment is not required for the first hosted capture and retrieval loop."
revisit_when: "Baseline retrieval evidence shows graph enrichment is the next constraint."
title: "Memory Trace Structural Graph Enrichment Provider Proposal"
date: "2026-07-15"
project: "memory-seed"
status: "promoted-to-todo"
priority: "P1"
recommended_target: "docs/8_Deferred/memory-trace-structural-graph-enrichment-provider-proposal.md"
related:
  ...
  - "docs/7_Replaced/memory-trace-graph-visualisation-and-temporal-topology-proposal.md"
