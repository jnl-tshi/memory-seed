# 8_Deferred — parked / long-horizon

Ideas that are real but deliberately not now — waiting on a dependency, a decision, or simply a later
season. Distinct from `2_Todo` (active) and from `6_Rejected` (declined): a deferred item is expected to
return.
...
| [reflection-workstream-future.md](reflection-workstream-future.md) | — | — | — |
