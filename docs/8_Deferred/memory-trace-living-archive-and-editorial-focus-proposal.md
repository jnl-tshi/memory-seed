...
deferred_reason: "Living-archive editorial controls are post-MVP UX work."
revisit_when: "The hosted retrieval surface is stable enough to test editorial focus controls."
...
6. **What user test justifies making this the B0b visual target?** — **A task-completion test**: time and
   ...
   [`memory-quality-metrics-v0-proposal.md`](../2_Todo/memory-quality-metrics-v0-proposal.md) rather than as a
