...
deferred_reason: "Semantic projections are deliberately downstream of the capture-first MVP."
revisit_when: "The SQL-authoritative hosted corpus and retrieval contracts are stable."
