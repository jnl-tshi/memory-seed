...
deferred_reason: "Constitutional diagram work is optional after the hosted MVP documentation consolidation."
revisit_when: "A ratified ADR or hosted control-plane decision needs a diagram that materially improves understanding."
