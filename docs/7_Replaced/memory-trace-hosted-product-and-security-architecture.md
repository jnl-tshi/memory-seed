...
disposition_note: "Its security controls remain useful input, but the Markdown-settlement and sync architecture was replaced by the SQL-authoritative hosted edition contract."
...
Dependencies: `memory-trace-product-and-system-architecture-blueprint.md`, `memory-trace-commercialisation-and-monetisation-report.md`, `memory-trace-evidence-annotations-and-projection-architecture.md`, the candidate [`hosted Markdown settlement contract`](../6_Rejected/memory-trace-hosted-markdown-settlement-contract.md), an explicit hosted-tier decision, and a later security review.
...
The candidate
[`hosted Markdown settlement and projection contract`](../6_Rejected/memory-trace-hosted-markdown-settlement-contract.md)
