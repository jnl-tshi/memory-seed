...
tags:
  ...
  - worktrees
  - git-workflow
replaced_by: "../5_Completed/agent-worktree-and-branch-hygiene-plan.md"
...
- `docs/7_Replaced/worktree-gc-proposal.md` — the superseded source for the **executor** this policy
