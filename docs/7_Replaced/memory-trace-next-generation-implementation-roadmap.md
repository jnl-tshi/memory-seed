...
Gate: establish the read-only baseline from [`memory-quality-metrics-v0-proposal.md`](../2_Todo/memory-quality-metrics-v0-proposal.md) before any quality label affects ranking or agent behaviour. Generated output remains non-authoritative unless explicitly promoted.
...
> [`memory-trace-ai-timeline-summarisation-plan.md`](../8_Deferred/memory-trace-ai-timeline-summarisation-plan.md).
