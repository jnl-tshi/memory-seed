...
appropriate. Mermaid is already used ad hoc in this repo's own docs (`docs/todo/3.0-plan.md`,
`docs/functionality-audit.md`, `docs/todo/completed/multi-user-deep-research-report.md`,
`docs/todo/user-interface-deep-research-report.md`) with no consistent rule for when it earns its
