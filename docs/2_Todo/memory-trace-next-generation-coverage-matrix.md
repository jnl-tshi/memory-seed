...
- **UX M0 delivered 2026-07-30:** `memory-trace-ux-m0-interaction-matrix.md` names the authoritative
  inputs, deterministic fixtures, and delivery status for Trail, Graph, Inspector, Reader, search, and
  information-state grammar. The next UX increment is M1 decision-reader/evidence return, not a new
  renderer or canonical data field.
