...
|---|---|---|---|
| [declarative-retrieval-specification-proposal.md](declarative-retrieval-specification-proposal.md) | P1 | — | Freeze the v1 slice and fixtures, then implement the shared resolver and MCP preview/resolve pa… |
