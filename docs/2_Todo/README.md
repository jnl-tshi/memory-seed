...
| [write-time-topic-envelope-closure-proposal.md](write-time-topic-envelope-closure-proposal.md) | P1 | — | JNL to accept or reject; this is step 3 of an already-accepted build order, plus one addition |
