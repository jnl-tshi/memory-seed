...
| [reflection-ledger-workstream-evolution-plan.md](reflection-ledger-workstream-evolution-plan.md) | P1 | — | Independently review the single-ledger workstream contract before implementation. |
