...
| [reflection-ledger-workstream-evolution-plan.md](reflection-ledger-workstream-evolution-plan.md) | P1 | — | Verify implementation work against the frozen v2 contract; do not reopen it without a new archi… |
