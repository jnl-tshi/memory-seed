...
|---|---|---|---|
| [seed-pod-p0-reconciliation-plan.md](seed-pod-p0-reconciliation-plan.md) | P0 | G0 independent re-review approval and stabilized Reflection… | Independently re-review this v2-aligned P0 plan; record G0 approval and verify the reflection r… |
