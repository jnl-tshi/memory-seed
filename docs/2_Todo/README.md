...
| [write-time-sidecar-consolidation-proposal.md](write-time-sidecar-consolidation-proposal.md) | P2 | — | JNL to accept or reject the design. If accepted, build in the stated order — block format + pro… |
