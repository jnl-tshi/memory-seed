...
> `docs/2_Todo/completed/README Improvements.md`. This todo-path copy remains only because OneDrive
> denied removal of the reparse-point file. Canonical active plan:
