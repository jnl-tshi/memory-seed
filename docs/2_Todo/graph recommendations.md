...
> `docs/2_Todo/completed/graph recommendations.md`. This todo-path copy remains only because
> OneDrive denied removal of the reparse-point file. Canonical reference:
