...
This folder holds normative Memory Seed specs that current code and future work should obey.
...
- `memory-trace-trail-search-and-graph-ux.md` is the proposed UX contract for next-generation
  Memory Trace Trail/search/graph behaviour.
- `memory-trace-derived-artifact-provenance-contract.md` is the proposed provenance contract for
