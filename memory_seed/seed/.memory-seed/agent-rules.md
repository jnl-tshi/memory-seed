...
- Preserve visible branch history for distinct feature work by loading `agent_collaboration.md` before editing and using a task branch/worktree unless the user chooses another history model; for branch/worktree write work, run its agent-namespace guard preflight first.
