...
governing_adr: adr_foreign_file_routing
tags:
  - memory-seed
  - skill
  - document-ingestion
...
3. Respect the runtime's data policy — do not auto-convert sensitive or raw source rows; prefer aggregates and ask first.
