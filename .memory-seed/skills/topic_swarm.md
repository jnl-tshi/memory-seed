...
`docs/1_Inbox/decision-level-topics-proposal.md` and this prompt teaches them verbatim.
...
- A decision-level consumer must exist before the full campaign runs — the gate recorded in
  `docs/1_Inbox/decision-level-topics-proposal.md`. Judging 922 units that nothing renders is waste.

See `docs/3_Spec/draft/decision-level-topic-sidecars.md` for the grammar and precedence contract, and
`docs/1_Inbox/decision-level-topics-proposal.md` for the two-axis conventions and why the cap is 3.
