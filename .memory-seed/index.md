...
- **DRAFT single-decision baseline; D/R mandatory; numbered decisions canonical** - The single-decision DRAFT record is the baseline session-entry shape. ADR [`adr_draft_format`](decisions/adr_draft_format.md)
