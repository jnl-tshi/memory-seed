...
- Docs taxonomy: `docs/todo/` holds open memory-seed roadmap proposals; `docs/todo/completed/` holds proposals that shipped or were otherwise resolved, plus the standalone persona-template asset (`docs/todo/completed/agent-templates/`); `docs/todo/codex/` and `docs/todo/Claude/` hold per-agent synthesis/evaluation reports.
